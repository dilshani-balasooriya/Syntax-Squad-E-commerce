...
const Features = ({ features }) => {
  return (
    <div>
      <div className="p-10 border shadow-md rounded-xl my-7 bg-blue-50">
        <h2 className="font-medium text-2xl text-primary">Features</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 mt-5 lg:grid-cols-4 gap-7">
          {features &&
            Object.entries(features)
              ...
              .map(([feature, value]) => (
                <div key={feature} className="flex gap-2 items-center text-primary">
                  {value ? (
